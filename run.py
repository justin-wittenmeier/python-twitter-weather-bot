...
class Bot:
    def __init__(self):
        ...
        self.auth = tweepy.OAuthHandler(self.twitter_oauth[0], self.twitter_oauth[1]) # twitter login info
        self.auth.set_access_token(self.twitter_token[0], self.twitter_token[1]) # twitter login info
    ...
    def weatherUpdate(self):
        ...
        self.api.update_status(manchester_weather)
